...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<link href="MyShop/web/css/bootstrap.min.css" rel="stylesheet">
		<script type="text/javascript" src="MyShop/web/js/jquery.min.js"></script>
		
<link rel="stylesheet" type="text/css" href="MyShop/web/css/login.css">
	...
	<div class="regist">
		<div class="regist_center">
			<div class="regist_top">
				...
				<div class="right fr">
					<a href="MyShop/web/index.jsp" target="_black">小米商城</a>
				</div>
				<div class="clear"></div>
