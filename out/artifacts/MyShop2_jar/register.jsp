	...
	<div class="regist">
		<div class="regist_center">
			<div class="regist_top">
				...
				<div class="right fr">
					<a href="web/index.jsp" target="_black">小米商城</a>
				</div>
				<div class="clear"></div>
			...
			<div class="center-block" style="margin-top: 80px;">
				<form class="form-horizontal" action="user?method=register" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
						<p class="text-danger"><span class="help-block ">请不要输入6位以上字符</span></p>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-2">
						<p class="text-danger"><span class="help-block ">两次密码要输入一致哦</span></p>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
						<p class="text-danger"><span class="help-block ">填写正确邮箱格式</span></p>
						</div>
					</div>
					<div class="form-group">
